...
"""Creates a temp database, creates a user, adds a internship that is in a later stage such as interview stage
...
"""Tests a case in which which the user inputs a rejected internship
   We want to make sure that sicne a rejection can come from any stage of the internship process that it does not
